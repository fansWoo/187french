...
<div class="contentBox allWidth">
	...
	<div class="spanLine noneBg">
        <div class="spanLineLeft">
			<a href="admin/dynamic/postclass/add" class="button">新增標籤</a>
        </div>
    ...
    <div class="spanLine">
        ...
        <div class="spanLineLeft width300 hoverHidden">
            <a href="admin/dynamic/dynamiclist/classid/<?=$value['classid']?>">查看</a> | 
            <a href="admin/dynamic/postclass/edit/<?=$value['classid']?>">編輯</a> | 
            <span class="ahref" onClick="check_action('確定要刪除這個標籤？', 'admin/dynamic/delete_class/<?=$value['classid']?>/<?=$this->security->get_csrf_hash()?>');">刪除</span>
        </div>
	</div>
    <?endforeach?>
</div>
