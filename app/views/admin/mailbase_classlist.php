...
<div class="contentBox allWidth">
	...
	<div class="spanLine noneBg">
        <div class="spanLineLeft">
			<a href="admin/mailbase/postclass/add" class="button">新增標籤</a>
        </div>
    ...
    <div class="spanLine">
        ...
        <div class="spanLineLeft width300 hoverHidden">
            <?if(0):?><a href="admin/mailbase/mailbaselist/classid/<?=$value['classid']?>">查看</a> | <?endif?>
            <a href="admin/mailbase/postclass/edit/<?=$value['classid']?>">編輯</a> | 
            <span class="ahref" onClick="fanScript.check_href_action('確定要刪除這個標籤？', 'admin/mailbase/delete_class/<?=$value['classid']?>/<?=$this->security->get_csrf_hash()?>');">刪除</span>
        </div>
	</div>
    <?endforeach?>
</div>
