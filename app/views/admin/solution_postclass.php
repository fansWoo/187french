...
<h2>解決方案管理 - <?if(isset($class['classid'])):?>編輯<?else:?>新增<?endif?>分類標籤</h2>
<div class="contentBox allWidth">
	<h3><?if(isset($class['classid'])):?>編輯<?else:?>新增<?endif?>分類標籤</h3>
	<h4>請填寫解決方案標籤資訊</h4>
	<?php echo form_open('admin/solution/postclass/post') ?>
	<div class="spanLine">
	    <div class="spanStage">
	    ...
	    <div class="spanStage">
            ...
            <div class="spanLineRight">
                <p class="gray">請輸入分類標籤的名稱，此標籤名稱可供解決方案作分類</p>
            </div>
		</div>
	</div>
	<div class="spanLine">
	...
	<div class="spanLine spanSubmit">
		...
		<div class="spanLineRight">
            ...
            <?if( empty($class['classid']) === FALSE ):?><span class="submit gray" onClick="fanScript.check_href_action('確定要刪除這個分類？', 'admin/solution/delete_class/<?=$class['classid']?>/<?=$this->security->get_csrf_hash()?>');">刪除分類</span><?endif?>
		</div>
	</div>
	</form>
</div>
