...
<div class="contentBox allWidth">
	...
	<h4>請填寫欲文章標籤資訊</h4>
	<?php echo form_open('admin/contact/postclass/post') ?>
	<div class="spanLine">
	    <div class="spanStage">
	...
	<div class="spanLine spanSubmit">
		...
		<div class="spanLineRight">
            ...
            <?if( empty($class['classid']) === FALSE ):?><span class="submit gray" onClick="fanScript.check_href_action('確定要刪除這個分類？', 'admin/contact/delete_class/<?=$class['classid']?>/<?=$this->security->get_csrf_hash()?>');">刪除分類</span><?endif?>
		</div>
	</div>
	</form>
</div>
