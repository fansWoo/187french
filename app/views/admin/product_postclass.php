...
<h2>產品系統管理 - <?if(isset($class['classid'])):?>編輯<?else:?>新增<?endif?>分類標籤</h2>
<div class="contentBox allWidth">
	<h3><?if(isset($class['classid'])):?>編輯<?else:?>新增<?endif?>分類標籤</h3>
	<h4>請填寫產品標籤資訊</h4>
	<?php echo form_open('admin/product/postclass/post') ?>
	<div class="spanLine">
	    <div class="spanStage">
	...
	<div class="spanLine spanSubmit">
		...
		<div class="spanLineRight">
            ...
            <?if( empty($class['classid']) === FALSE ):?><span class="submit gray" onClick="fanScript.check_href_action('確定要刪除這個分類？', 'admin/product/delete_class/<?=$class['classid']?>/<?=$this->security->get_csrf_hash()?>');">刪除分類</span><?endif?>
		</div>
	</div>
	</form>
</div>
