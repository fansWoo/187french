			...
			<div class="bottomBox">
				...
				<div class="itemBox">
					<div class="item">
						...
						<div class="text">
							<h2>法國進口巧克力</h2>
							<p>選用法國最頂級的兩大品牌巧克力Cacao和法芙娜，使用不同莊園生產的可可去做調配，為各式甜點調配出專屬的最佳比例。(40%、55%、64%、66%、70%、85%、白巧克力)</p>
						</div>
					</div>
					<div class="item">
						<div class="pic">
						...
						<div class="text">
							<h2>天然添加物</h2>
							<p>製作甜點時添加適量的天然香料，增添芳香特質外，更能提升糕點細緻度與味蕾的層次。(香草粉、香草莢、法國色粉、肉桂粉、紅椒粒、食用乾燥花、玫瑰水)</p>
						</div>
					</div>
					<div class="item">
						<div class="pic">
