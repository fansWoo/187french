...
class Solution extends CI_Controller {
	...
	public function postsolution($do = '', $solutionid = 0)
	{
		...
		if($do == 'post')
        {
            ...
            if ($this->form_validation->run() !== FALSE)
            {
                ...
                $this->solution_model->construct( array('brandid' => $brandid, 'title' => $title, 'href' => $href, 'classid_array' => $classid_array, 'picid_array' => $picid_array, 'toppicid_array' => $toppicid_array, 'content' => $content, 'prioritynum' => $prioritynum) );
	...
	public function brandlist($input = '')
	{
		...
		else
		{
            ...
            $this->brand_list_model->set_db(array(
                'db_where' => array(
            ...
            $data['brand_links'] = $this->brand_list_model->create_links( array('base_url' => 'admin/brand/brandlist') );
	...
	public function postclass($do = '', $classid = 0)
	{
		...
		else
		{
            ...
            {
                $this->load->model('class_model');
                $this->class_model->db_construct( array('db_where' => array('classid' => $classid, 'modelname' => 'brand') ) );
	...
	public function classlist($input = '')
	{
		...
		else
		{
            ...
            $data['class_links'] = $this->class_list_model->create_links( array('base_url' => 'admin/brand/classlist') );
