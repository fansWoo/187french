...
class showpiece_controller extends FS_controller {
    ...
    public function edit()
    {
        ...
        $data['class2_ClassMetaList']->construct_db(array(
            'db_where_Arr' => array(
                'modelname_Str' => 'showpiece_shop_class2'
            ),
            'model_name_Str' => 'ClassMeta',
            'limitstart_Num' => 0,
            'limitcount_Num' => 100
    ...
    public function edit_post()
    {
        ...
        $this->form_validation->set_rules('title_Str', '產品名稱', 'required');
        ...
        if ($this->form_validation->run() !== FALSE)
        {
            ...
            $this->Message->show(array(
                'message' => '設定成功',
                'url' => 'admin/shop/showpiece_shop/showpiece/tablelist'
            ));
        }
        else
        {
    ...
    public function tablelist_post()
    {
        ...
        $url_Str = base_url('admin/shop/showpiece_shop/showpiece/tablelist/?');
    ...
    public function delete()
    {
        ...
        if($hash_Str == $this->security->get_csrf_hash())
        {
            ...
            $this->Message->show(array(
                'message' => '刪除成功',
                'url' => 'admin/shop/showpiece_shop/showpiece/showpiece_list'
            ));
        }
        else
        {
