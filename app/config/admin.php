...
$admin['ac_father_online'] = array(
	...
	'websiteset', 'webcontent', 'dynamic', 'note', 'merchandise', 'solution', 'product', 'mailbase','contact'
);
...
$admin['admin_sidebox'] = array(
	array(
		...
		'ac_father' => array(
			...
			array(
				'title' => '產品', 'name' => 'product',
				'ac_child' => array(
					array('title' => '新增產品', 'name' => 'postproduct'),
					array('title' => '產品列表', 'name' => 'productlist'),
					array('title' => '新增產品分類', 'name' => 'postclass'),
					array('title' => '產品分類列表', 'name' => 'classlist'),
				)
			),
			array(
				'title' => '解決方案', 'name' => 'solution',
				'ac_child' => array(
					array('title' => '新增解決方案', 'name' => 'postsolution'),
					array('title' => '解決方案列表', 'name' => 'solutionlist'),
					array('title' => '新增方案分類', 'name' => 'postclass'),
					array('title' => '方案分類列表', 'name' => 'classlist')
				)
			),
			array(
				'title' => '動態頁面', 'name' => 'dynamic',
				'ac_child' => array(
					array('title' => '新增動態頁面', 'name' => 'postdynamic'),
					array('title' => '動態頁面列表', 'name' => 'dynamiclist'),
			...
			array(
				'title' => '電子郵件管理', 'name' => 'mailbase',
				'ac_child' => array(
					array('title' => '新增郵件', 'name' => 'postmailbase'),
					array('title' => '電子郵件列表', 'name' => 'mailbaselist'),
					array('title' => '新增分類標籤', 'name' => 'postclass'),
					array('title' => '分類標籤列表', 'name' => 'classlist')
				)
			),
