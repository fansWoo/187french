...
class Course extends ObjDbBase
{

    public $courseid_Num = 0;
    public $uid_Num = 0;
    public $name_Str = '';
    ...
    public $status_Num = 1;
    public $db_name_Str = 'course';//填寫物件聯繫資料庫之名稱
    public $db_uniqueid_Str = 'courseid';//填寫物件聯繫資料庫之唯一ID
    public $db_field_Arr = array(//填寫資料庫欄位與本物件屬性之關係，前者為資料庫欄位，後者為屬性
        'courseid' => 'courseid_Num',
        'uid' => 'uid_Num',
        'name' => 'name_Str',
        'price' => 'price_Num',
    ...
    {
        //引入引數並將空值的變數給予空值
        reset_null_arr($arg, ['courseid_Num', 'uid_Num', 'name_Str', 'picids_Str', 'picids_Arr', 'content_Str', 'price_Num', 'precautions_Str', 'coursetime1_Str', 'coursetime2_Str', 'classids_Str', 'classids_Arr', 'prioritynum_Num', 'updatetime_Str', 'updatetime_inputtime_date_Str', 'updatetime_inputtime_time_Str', 'status_Num']);
        foreach($arg as $key => $value) ${$key} = $arg[$key];
        
        //將引數設為物件屬性，或將引數作為物件型屬性的建構值
        $this->set('courseid_Num', $courseid_Num);
